...
export class Session extends Message<Session> {
   ...
   *
   * @generated from field: string group_label = 20;
   */
  groupLabel = "";
...
/**
 * @generated from message brigade.v1.ReloadAgentRequest
 */
export class ReloadAgentRequest extends Message<ReloadAgentRequest> {
  /**
   * @generated from field: string session_id = 1;
   */
  sessionId = "";
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "brigade.v1.ReloadAgentRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "session_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
